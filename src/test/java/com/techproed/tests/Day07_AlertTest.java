...
public void acceptAlert(){
    ...
    //verify the text "Iam a Js alert
    String alertText=driver.switchTo().alert().getText();
    Assert.assertEquals(alertText,"I am a JS Alert");
    //click ok
    driver.switchTo().alert().accept();//accept means =ok

    //verify "You successfully clicked on alert"
    String result=driver.findElement(By.id("result")).getText();
    Assert.assertEquals(result,"You successfully clicked an alert");


    }
    //  dismissAlert()=> click on the second alert, verify text
    //  "I am a JS Confirm”, click cancel, and Verify “You clicked: Cancel”
    @Test
